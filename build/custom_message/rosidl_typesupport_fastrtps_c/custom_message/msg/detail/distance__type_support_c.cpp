...
#include "custom_message/msg/detail/distance__rosidl_typesupport_fastrtps_c.h"
...
using _Distance__ros_msg_type = custom_message__msg__Distance;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_message
bool cdr_serialize_custom_message__msg__Distance(
  const custom_message__msg__Distance * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_message
bool cdr_deserialize_custom_message__msg__Distance(
  eprosima::fastcdr::Cdr & cdr,
  custom_message__msg__Distance * ros_message)
{
  // Field name: distance
  {
    cdr >> ros_message->distance;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_message
size_t get_serialized_size_custom_message__msg__Distance(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_message
size_t max_serialized_size_custom_message__msg__Distance(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_message__msg__Distance;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_message
bool cdr_serialize_key_custom_message__msg__Distance(
  const custom_message__msg__Distance * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: distance
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_message
size_t get_serialized_size_key_custom_message__msg__Distance(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Distance__ros_msg_type * ros_message = static_cast<const _Distance__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_message
size_t max_serialized_size_key_custom_message__msg__Distance(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const custom_message__msg__Distance * ros_message = static_cast<const custom_message__msg__Distance *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_custom_message__msg__Distance(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  custom_message__msg__Distance * ros_message = static_cast<custom_message__msg__Distance *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_custom_message__msg__Distance(cdr, ros_message);
}

static uint32_t _Distance__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_message__msg__Distance(
...
static size_t _Distance__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_message__msg__Distance(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_message, msg, Distance)() {
