...
#ifndef CUSTOM_MESSAGE__SRV__DETAIL__THRESHOLD__TYPE_SUPPORT_H_
#define CUSTOM_MESSAGE__SRV__DETAIL__THRESHOLD__TYPE_SUPPORT_H_
...
#endif  // CUSTOM_MESSAGE__SRV__DETAIL__THRESHOLD__TYPE_SUPPORT_H_
