...
bool custom_message__msg__distance__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_message.msg._distance.Distance", full_classname_dest, 37) == 0);
  }
  custom_message__msg__Distance * ros_message = _ros_message;
  {  // distance
...
PyObject * custom_message__msg__distance__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_message.msg._distance");
